...
public class ManagerController {
    ...
    public ResponseDTO<?> updateTime(@RequestBody SelectionTime selectionTime) {
        // 调用服务层更新选课系统时间
    ...
    public ResponseDTO<?> setCurriculum(@RequestBody CurriculumDTO curriculumDTO) {
        // 调用服务层设置培养方案
     ...
     */
    @GetMapping("/get_time")
    public ResponseDTO<SelectionTime> getTime() {
        // 调用服务层获取选课系统时间
    ...
    public ResponseDTO<SupplementListDTO> getSupplement(@RequestParam(name = "course_id", required = false) Integer courseId) {
        // 调用服务层获取补选申请列表
    ...
    public ResponseDTO<?> submitSupplement(@RequestBody SupplementResultDTO supplementResultDTO) {
        // 调用服务层处理补选申请
