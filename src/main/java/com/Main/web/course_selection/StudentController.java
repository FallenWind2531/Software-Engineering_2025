...
public class StudentController {
    ...
    public ResponseDTO<?> chooseCourse(@RequestBody StudentCourseRequest request) {
        // 调用服务层选择课程，courseId实际上是sectionId
    ...
    public ResponseDTO<?> dropCourse(@RequestBody StudentCourseRequest request) {
    ...
    public ResponseDTO<CourseListDTO> showSelectedCourses(@RequestParam(name = "student_id") Integer studentId) {
    ...
    public ResponseDTO<CurriculumDTO> getPersonalCurriculum(@RequestParam(name = "student_id") Integer studentId) {
    ...
    public ResponseDTO<?> setPersonalCurriculum(@RequestBody CurriculumDTO curriculumDTO) {
    ...
    public ResponseDTO<?> applySupplementCourse(@RequestBody SupplementApplicationDTO supplementApplicationDTO) {
        // 调用服务层提交补选申请
    ...
    public ResponseDTO<SupplementResultListDTO> getSupplementResult(@RequestParam(name = "student_id") Integer studentId) {
        // 调用服务层获取补选结果
